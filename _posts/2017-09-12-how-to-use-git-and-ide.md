...
1. 在github登录自己帐号，创建一个空的仓库（图-2.8）
...
![Git安装过程-图9](/images/2017-09-12/git-10.jpg)

创建成功后，就有了.git文件夹，还有其他文件会多了问号标志。这个是什么含义？下面会分节来介绍相关图标的含义。现在暂时不管，你只需要知道这些带问号图标的文件，是属于被git识别，但是还未加入版本控制内的文件。

创建本地库成功后，把本文件夹内的文件，都加入到git版本控制中。
